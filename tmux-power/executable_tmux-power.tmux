...
time_format=$(tmux_get @tmux_power_time_format '%l:%M:%S %p')
...
# RS="#[fg=$TC,bg=$G06]$larrow#[fg=$G04,bg=$TC] #W #[fg=$G06]$larrow#[fg=$TC,bg=$G06] $time_icon $time_format #[fg=$TC,bg=$G06]$larrow#[fg=$G04,bg=$TC] $date_icon $date_format "
RS="#[fg=$G06]$larrow#[fg=$TC,bg=$G06] #W #[fg=$TC,bg=$G06]$larrow#[fg=$G04,bg=$TC] $time_icon $time_format #[fg=$G06]$larrow#[fg=$TC,bg=$G06] $date_icon $date_format "
...
tmux_set window-status-format "#[fg=$BG,bg=$G06]$rarrow#[fg=$TC,bg=$G06] #I:#{b:pane_current_path} #[fg=$G06,bg=$BG]$rarrow"
tmux_set window-status-current-format "#[fg=$BG,bg=$TC]$rarrow#[fg=$BG,bg=$TC,bold] #I:#{b:pane_current_path} #[fg=$TC,bg=$BG,nobold]$rarrow"
